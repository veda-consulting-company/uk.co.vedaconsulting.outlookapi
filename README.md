...
<ul>
   <li>
      ...
      <i><a style="color:#1298ED;" href="https://www.outlook-apps.com/outlook-2013-disabled-add-ins/" target="_blank">(Click here if you can't see the tab)</a></i>
   </li>
   <br/>
   <li>
   ...
   <p><b>How does OutlookForCiviCRM handle contacts that are sent from Outlook to CiviCRM?</b></p>
   <ul>
        <li>1. If a contact does not exist in CiviCRM, it creates a new contact and creates an activity for that.</li>
        <li>2. If contact exists in CiviCRM, it creates an activity for that contact.</li>
        <li>3. If duplicates are found in CiviCRM for a contact, duplicates are returned back to Outlook and you can choose which contact you want to create an activity with. </li>
        <p><img src="http://www.vedaconsulting.co.uk/sites/default/files/veda-uploads/uploads/2015/OutlookForCiviCRM/1.1/Step-5.png" alt="" /></p>
   </ul>
   </li>
</ul>
