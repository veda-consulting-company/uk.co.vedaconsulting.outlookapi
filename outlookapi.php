...
function outlookapi_civicrm_alterAPIPermissions($entity, $action, &$params, &$permissions) {
  //Native APIs
  $permissions['domain']['get'] = array('access CiviCRM', 'access AJAX API');
  $permissions['activity']['create'] = array('access CiviCRM', 'access AJAX API', 'add contacts', 'view all contacts', 'view all activities', 'access uploaded files');
